...
*               Original code from Mesa, written by an unknown programmer.
*
****************************************************************************/
...
static int      circle_subdiv;
static float    a1,a2,a3,a4,i1,i2,i3,i4;
