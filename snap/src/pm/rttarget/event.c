...
static ibool                    bKeyPressed = false;    /* Internal KeyPressed state    */
static RTKTaskHandle            tskEvent = NULL;        /* Event helper thread handle   */
...
****************************************************************************/
static void RTKAPI keyboardISR(void)
{
    char kbval;
