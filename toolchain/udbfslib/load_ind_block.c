// $Header: /home/xubuntu/berlios_backup/github/tmp-cvs/uuu/Repository/toolchain/udbfslib/load_ind_block.c,v 1.9 2003/10/13 22:12:54 bitglue Exp $
...
int		udbfslib_load_ind_block(
  ...
  printf("ind_block [%016" UINT64_FORMAT "X] allocated to [%p]\n", block_id, ind_block);
  ...
  *linkpoint = ind_block;
  ...
  for( i = 0; i<ind_links; i++ ) {
	...
	fprintf(stderr,"udbfslib: error happened while loading bi-indirects of tri-indirect block [%016" UINT64_FORMAT "X]\n", ind_block->id);
	return( -1 );
      }
    }
