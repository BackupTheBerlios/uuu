...
typedef struct _REF2D_driver {
    ...
    GA_buffer *         (NAPIP GetDrawBuffer)(void);
    void                (NAPIP DrawRectExtSW)(void *buffer,N_int32 dstPitch,N_int32 left,N_int32 top,N_int32 width,N_int32 height,GA_color color,N_int32 mix);
...
ibool   NAPI REF2D_loadDriver(GA_devCtx _FAR_ *hwCtx,N_int32 bitsPerPixel,N_int32 shared,REF2D_driver _FAR_ *_FAR_ *drv,PE_MODULE _FAR_ *_FAR_ *hModRef,ulong _FAR_ *size);
void    NAPI REF2D_unloadDriver(REF2D_driver _FAR_ *drv,PE_MODULE _FAR_ *hModule);

/* {secret} */
ibool   NAPI SHADOW_loadDriver(GA_devCtx _FAR_ *hwCtx,GA_globalOptions *opt,REF2D_driver _FAR_ * _FAR_ *drv,PE_MODULE _FAR_ * _FAR_ *hModule,ulong _FAR_ *size);
/* {secret} */
ibool   NAPI PORTRAIT_loadDriver(GA_devCtx _FAR_ *hwCtx,GA_globalOptions *opt,REF2D_driver _FAR_ * _FAR_ *drv,PE_MODULE _FAR_ * _FAR_ *hModule,ulong _FAR_ *size);
/* {secret} */
ibool   NAPI FLIPPED_loadDriver(GA_devCtx _FAR_ *hwCtx,GA_globalOptions *opt,REF2D_driver _FAR_ * _FAR_ *drv,PE_MODULE _FAR_ * _FAR_ *hModule,ulong _FAR_ *size);
/* {secret} */
ibool   NAPI INVERT_loadDriver(GA_devCtx _FAR_ *hwCtx,GA_globalOptions *opt,REF2D_driver _FAR_ * _FAR_ *drv,PE_MODULE _FAR_ * _FAR_ *hModule,ulong _FAR_ *size);
/* {secret} */
ibool   NAPI MULDISP_loadDriver(GA_devCtx _FAR_ * _FAR_ *hwCtx,N_int32 numDevices,GA_globalOptions *opt,REF2D_driver _FAR_ * _FAR_ *drv,PE_MODULE _FAR_ * _FAR_ *hModule,ulong _FAR_ *size,GA_setActiveDevice_t setActiveDevice);
#ifdef  __DRIVER__
/* {secret} */
