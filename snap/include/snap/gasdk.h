...
extern REF2D_driver     *ref2d1,*ref2d4,*ref2d8,*ref2d16,*ref2d24,*ref2d32;
extern PE_MODULE        *hMod1,*hMod4,*hMod8,*hMod16,*hMod24,*hMod32;
extern GA_2DStateFuncs  state2d1,state2d4,state2d8,state2d16,state2d24,state2d32;
extern GA_2DRenderFuncs draw2d1,draw2d4,draw2d8,draw2d16,draw2d24,draw2d32;
...
void    LoadSysMemDriver(int bitsPerPixel);
