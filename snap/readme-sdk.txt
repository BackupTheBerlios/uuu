...
included in this release are:
 ...
 snap_sdk_2.3-r12-src.zip        - SNAP source archive in DOS/Win format
 snap_sdk_2.3-r12-dos.zip        - DOS hosted base utilities
 snap_sdk_2.3-r12-win32.zip      - Win32 hosted base utilities
 snap_sdk_2.3-r12-os2.zip        - OS/2 hosted base utilities
 snap_sdk_2.3-r12-drivers.zip    - SciTech SNAP device driver binaries
 snap_sdk_2.3-r12-util.zip       - Source code for base utilities
 snap_sdk_2.3-r12-docs.zip       - SDK documentation in HTML format
 snap_sdk_2.3-r12-pdf.zip        - SDK documentation in Adobe PDF format

 snap_sdk_2.3-r12-src.tar.gz     - Source archive in Unix format
 snap_sdk_2.3-r12-linux.tar.gz   - Linux hosted base utilities
 snap_sdk_2.3-r12-qnx.tar.gz     - QNX hosted base utilities
 snap_sdk_2.3-r12-drivers.tar.gz - SciTech SNAP device driver binaries
 snap_sdk_2.3-r12-util.tar.gz    - Source code for base utilities
 snap_sdk_2.3-r12-docs.tar.gz    - SDK documentation in HTML format
 snap_sdk_2.3-r12-pdf.tar.gz     - SDK documentation in Adobe PDF format
...
you will not need *any* of the files listed above:
 ...
 full_depot_r12.zip              - Complete copy of GPL depot in DOS/Win format
 full_depot_r12.tar.gz           - Complete copy of GPL depot in Unix format
