...
SET LIB=%SCITECH_LIB%\LIB\RELEASE\LINUX\OW10;%OW10_PATH%\LIB386;%OW10_PATH%\LIB386\LINUX;.
echo Release build enabled.
goto setvars

:checked_build
SET LIB=%SCITECH_LIB%\LIB\DEBUG\LINUX\OW10;%OW10_PATH%\LIB386;%OW10_PATH%\LIB386\LINUX;.
