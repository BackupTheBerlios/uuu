...
SET LIB=%SCITECH_LIB%\LIB\RELEASE\DOS32\OW10;%OW10_PATH%\LIB386;%OW10_PATH%\LIB386\DOS;%TNT_PATH%\LIB;.
echo Release build enabled.
goto setvars

:checked_build
SET LIB=%SCITECH_LIB%\LIB\DEBUG\DOS32\OW10;%OW10_PATH%\LIB386;%OW10_PATH%\LIB386\DOS;%TNT_PATH%\LIB;.
