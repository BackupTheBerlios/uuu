...
SET LIB=%SCITECH_LIB%\LIB\RELEASE\SNAP\OW10;%OW10_PATH%\LIB386;%OW10_PATH%\LIB386\SNAP;.
echo Release build enabled.
goto setvars

:checked_build
SET LIB=%SCITECH_LIB%\LIB\DEBUG\SNAP\OW10;%OW10_PATH%\LIB386;%OW10_PATH%\LIB386\SNAP;.
