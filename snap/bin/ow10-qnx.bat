...
SET LIB=%SCITECH_LIB%\LIB\RELEASE\QNX4\OW10;%OW10_PATH%\LIB386;%OW10_PATH%\LIB386\QNX;.
echo Release build enabled.
goto setvars

:checked_build
SET LIB=%SCITECH_LIB%\LIB\DEBUG\QNX4\OW10;%OW10_PATH%\LIB386;%OW10_PATH%\LIB386\QNX;.
