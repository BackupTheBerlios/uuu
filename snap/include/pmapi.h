...
#include <xf86_libc.h>
#elif !defined(__WIN32_VXD__) && !defined(__OS2_VDD__) && !defined(__NT_DRIVER__)
#include <stdio.h>
#include <stdlib.h>
#endif
...
ulong   _ASMAPI _swapw(ulong value);
ushort  _ASMAPI _swaphw(ushort value);
#define PM_paramLE_16(v)    _swaphw(v)
#define PM_paramLE_32(v)    _swapw(v)
#define PM_getLE_16(v)      ((u16)(_PM_TOI(v,1,8) | _PM_TOI(v,0,0)))
...
#define PM_convBE_16(v)
#define PM_convBE_32(v)
#else
...
#define PM_getBE_16(v)      ((u16)(_PM_TOI(v,1,0) | _PM_TOI(v,0,8)))
...
#define PM_convLE_16(v)
#define PM_convLE_32(v)
...
typedef struct {
    ...
    void    (PMAPIP PM_readMSR)(ulong reg, ulong PM_FAR *eax, ulong PM_FAR *edx);
    void    (PMAPIP PM_writeMSR)(ulong reg, ulong eax, ulong edx);
    } PM_imports;
...
void    PMAPI PM_lockSNAPAccess(int subsystem,ibool write);
void    PMAPI PM_unlockSNAPAccess(int subsystem);

/* Function to read/write MSR registers */
